...
export function LandingFooter() {
  return (
    <footer className="border-t border-[var(--border)]">
      <div className="mx-auto flex max-w-[1280px] flex-col gap-3 px-4 py-8 text-[13px] text-white/55 sm:flex-row sm:items-center sm:justify-between sm:gap-5 sm:px-6 lg:px-8">
