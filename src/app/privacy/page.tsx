    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 py-8 sm:py-12">
        <div className="container mx-auto max-w-3xl prose dark:prose-invert">
          ...
          <p>
            When you use AI SmartWills, we collect the following information:
          </p>
          <ul>
          ...
          <p>
            Your conversations with AI SmartWills are processed by third-party AI providers
          ...
          <p>
            AI SmartWills is not intended for users under 18 years of age.
